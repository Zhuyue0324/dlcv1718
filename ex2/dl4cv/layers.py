...
def affine_forward(x, w, b):
    ...
    #############################################################################
    x1=x.reshape(x.shape[0],w.shape[0])
    out=np.dot(x1,w)+b
    #############################################################################
    #                             END OF YOUR CODE                              #
    #############################################################################
...
def affine_backward(dout, cache):
    ...
    dw = np.dot(np.transpose(x.reshape(x.shape[0], w.shape[0])),dout)
...
def batchnorm_backward(dout, cache):
    ...
    dx+=1./N*np.ones((x_minus_mean.shape))*dsample_mean
    #############################################################################
    #                             END OF YOUR CODE                              #
    #############################################################################
